...
* **For general security concerns**, please open a [GitHub issue](https://github.com/ibrahimsql/aether/issues). Use the `security` label and describe the issue in as much detail as you can. This helps us to understand and address the problem more effectively.
* **For sensitive matters**, we encourage you to directly email for [me](mailto:ibrahimsql@proton.me). Handling these issues discreetly is vital for everyone's safety.
