...
import (
	...
	// voltFile "github.com/aether/file"
	// voltHar "github.com/aether/format/har"
	// voltUtils "github.com/aether/util"
...
func runRawDataMode(filePath string, cmd *cobra.Command) {
	...
	// TODO: voltFile, voltHar, voltUtils are undefined. Commenting out their usages to fix build errors.
...
func runHarMode(filePath string, cmd *cobra.Command, sf bool) {
	...
	// TODO: 'model.HARObject' is undefined. Commenting out to fix build error.
	// var harObject model.HARObject
